return function ()
	...
	add_dialogues({
		pwh_dwarf_internal_start_banter_c = {
			...
			sound_events = {
				[1.0] = "pwh_dwarf_internal_start_banter_c_01",
				[2.0] = "pwh_dwarf_internal_start_banter_c_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_dwarf_internal_start_banter_a = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_dwarf_internal_start_banter_a_01",
				[2.0] = "pwh_dwarf_internal_start_banter_a_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_dwarf_internal_start_banter_b = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_dwarf_internal_start_banter_b_01",
				[2.0] = "pwh_dwarf_internal_start_banter_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_dwarf_internal_engineer_reveal_b = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_dwarf_internal_engineer_reveal_b_01",
				[2.0] = "pwh_dwarf_internal_engineer_reveal_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
