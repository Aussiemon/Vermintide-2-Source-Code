return function ()
	...
	add_dialogues({
		...
		pwe_helmgart_military_b = {
			...
			sound_events = {
				[1.0] = "pwe_helmgart_military_b_01",
				[2.0] = "pwe_helmgart_military_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwe_helmgart_military_c = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwe_helmgart_military_c_01",
				[2.0] = "pwe_helmgart_military_c_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwe_helmgart_military_a = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwe_helmgart_military_a_01",
				[2.0] = "pwe_helmgart_military_a_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
