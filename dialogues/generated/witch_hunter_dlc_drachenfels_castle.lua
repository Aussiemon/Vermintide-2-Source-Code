return function ()
	...
	define_rule({
		name = "pwh_castle_vo_ meet_sorcerer",
		response = "pwh_castle_vo_ meet_sorcerer",
		criterias = {
			{
				"query_context",
				"concept",
	...
	add_dialogues({
		...
		["pwh_castle_vo_ meet_sorcerer"] = {
			...
			dialogue_animations_n = 4,
			sound_events = {
				"pwh_castle_vo_ meet_sorcerer_01",
				"pwh_castle_vo_ meet_sorcerer_02",
				"pwh_castle_vo_ meet_sorcerer_03",
				"pwh_castle_vo_ meet_sorcerer_04"
			},
			dialogue_animations = {
				"dialogue_talk",
				"dialogue_talk",
