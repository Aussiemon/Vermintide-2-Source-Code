return function ()
	...
	add_dialogues({
		...
		pwh_wizard_trail_intruders_b = {
			...
			sound_events = {
				[1.0] = "pwh_wizard_trail_intruders_b_01",
				[2.0] = "pwh_wizard_trail_intruders_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_wizard_trail_intro_c = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_wizard_trail_intro_c_01",
				[2.0] = "pwh_wizard_trail_intro_c_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_wizard_trail_lower_bridge_b = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_wizard_trail_lower_bridge_b_01",
				[2.0] = "pwh_wizard_trail_lower_bridge_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_wizard_trail_caravan_b = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_wizard_trail_caravan_b_01",
				[2.0] = "pwh_wizard_trail_caravan_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
		...
		pwh_wizard_trail_intro_b = {
			...
			dialogue_animations_n = 2,
			sound_events = {
				[1.0] = "pwh_wizard_trail_intro_b_01",
				[2.0] = "pwh_wizard_trail_intro_b_02"
			},
			dialogue_animations = {
				[1.0] = "dialogue_talk",
				[2.0] = "dialogue_talk"
