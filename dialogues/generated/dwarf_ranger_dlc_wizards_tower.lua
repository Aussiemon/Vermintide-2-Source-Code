return function ()
	...
	add_dialogues({
		...
		pdr_wizard_tower_intro_a = {
			...
			localization_strings = {
				[1.0] = "pdr_wizard_tower_intro_a_01",
				[2.0] = "pdr_wizard_tower_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1.0] = "pdr_wizard_tower_intro_a_01",
		...
		pdr_wizard_tower_intro_b = {
			...
			localization_strings = {
				[1.0] = "pdr_wizard_tower_intro_b_01",
				[2.0] = "pdr_wizard_tower_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1.0] = "pdr_wizard_tower_intro_b_01",
		...
		pdr_wizard_tower_intro_c = {
			...
			localization_strings = {
				[1.0] = "pdr_wizard_tower_intro_c_01",
				[2.0] = "pdr_wizard_tower_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1.0] = "pdr_wizard_tower_intro_c_01",
		...
		pdr_wizard_tower_where_is_she_a = {
			...
			localization_strings = {
				[1.0] = "pdr_wizard_tower_where_is_she_a_01",
				[2.0] = "pdr_wizard_tower_where_is_she_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1.0] = "pdr_wizard_tower_where_is_she_a_01",
		...
		pdr_wizard_tower_where_is_she_b = {
			...
			localization_strings = {
				[1.0] = "pdr_wizard_tower_where_is_she_b_01",
				[2.0] = "pdr_wizard_tower_where_is_she_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1.0] = "pdr_wizard_tower_where_is_she_b_01",
