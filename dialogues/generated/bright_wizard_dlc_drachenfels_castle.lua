return function ()
	...
	define_rule({
		name = "pbw_castle_vo_ meet_sorcerer",
		response = "pbw_castle_vo_ meet_sorcerer",
		criterias = {
			{
				"query_context",
				"concept",
	...
	add_dialogues({
		...
		["pbw_castle_vo_ meet_sorcerer"] = {
			...
			dialogue_animations_n = 4,
			sound_events = {
				"pbw_castle_vo_ meet_sorcerer_01",
				"pbw_castle_vo_ meet_sorcerer_02",
				"pbw_castle_vo_ meet_sorcerer_03",
				"pbw_castle_vo_ meet_sorcerer_04"
			},
			dialogue_animations = {
				"dialogue_talk",
				"dialogue_talk",
