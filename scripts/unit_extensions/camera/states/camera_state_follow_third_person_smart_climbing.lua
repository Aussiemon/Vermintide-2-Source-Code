...
CameraStateFollowThirdPersonSmartClimbing.init = function (self, camera_state_init_context)
...
CameraStateFollowThirdPersonSmartClimbing.on_enter = function (self, unit, input, dt, context, t, previous_state, params)
...
CameraStateFollowThirdPersonSmartClimbing.refresh_follow_unit = function (self, follow_unit, follow_node)
	self._follow_unit = follow_unit
	self._follow_node = follow_node
end

CameraStateFollowThirdPersonSmartClimbing.update = function (self, unit, input, dt, context, t)
	local csm = self.csm
