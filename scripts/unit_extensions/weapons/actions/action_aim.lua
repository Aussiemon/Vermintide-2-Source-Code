...
ActionAim.client_owner_start_action = function (self, new_action, t)
	...
	local aim_zoom_time = buff_extension:apply_buffs_to_value(new_action.aim_zoom_time or 0, StatBuffIndex.REDUCED_RANGED_CHARGE_TIME)
	...
	self.aim_zoom_time = t + aim_zoom_time
