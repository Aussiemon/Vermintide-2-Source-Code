...
VersusMissionObjectiveExtension._set_objective_data = function (self, objective_data)
	...
	self._on_leaf_complete_sound_event = objective_data.on_leaf_complete_sound_event or mission_default_settings.on_leaf_complete_sound_event
	self._on_section_progress_sound_event = objective_data.on_section_progress_sound_event or mission_default_settings.on_section_progress_sound_event
