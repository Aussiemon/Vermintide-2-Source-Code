...
ImguiDeusMapGen.draw = function (self, is_open)
	Imgui.begin_window("DeusMapGen", "always_auto_resize")
...
ImguiDeusMapGen._trigger_graph_render = function (self)
	...
	local graph = deus_generate_graph(self._seed, journey_names[self._journey_index], gods[self._dominant_god_index], self._populate_config)
	DeusDebugDrawMapSettings.base_graph = nil
