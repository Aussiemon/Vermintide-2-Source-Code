...
ByteArray.write_int32 = function (array, value, index)
...
ByteArray.read_int32 = function (array, index)
	index = index or 1
...
ByteArray.read_string = function (array, start_index, end_index)
...
ByteArray.write_string = function (array, str, start_index, str_start_index, str_end_index)
	start_index = start_index or 1
