...
UIWidgets.create_hero_screen_selector = function (scenegraph_id, size, amount)
	local default_color = {
		255,
		255,
		255,
	...
	for k = 1, amount, 1 do
		...
		local slot_size = (center_button and {
			135,
			135
		}) or {
			82,
		...
		local start_width_offset = -slot_size[1]
		...
		passes[#passes + 1] = {
			...
			style_id = icon_name,
			content_check_function = function (content)
				return content[icon_name] and not content[hotspot_name].is_selected
			end
		}
		style[icon_name] = {
			size = icon_size,
		...
		local icon_selected_name = "icon_selected" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "texture",
			texture_id = icon_selected_name,
			style_id = icon_selected_name,
			content_check_function = function (content)
				return content[icon_selected_name] and content[hotspot_name].is_selected
			end
		}
		style[icon_selected_name] = {
			size = icon_size,
			color = default_color,
			offset = {
				(offset[1] + slot_size[1]/2) - icon_size[1]/2,
		...
		local hover_texture_name = "hover_texture" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "texture",
			texture_id = hover_texture_name,
			style_id = hover_texture_name,
			content_check_function = function (content)
				return content[hotspot_name].is_hover and not content[hotspot_name].is_selected
			end
		}
		style[hover_texture_name] = {
			size = slot_size,
			color = default_color,
			offset = {
				offset[1],
		...
		content[hover_texture_name] = (center_button and "tabs_icon_bg_02_glow") or "tabs_icon_bg_01_glow"
		local selected_texture_name = "selected_texture" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "texture",
			texture_id = selected_texture_name,
			style_id = selected_texture_name,
			content_check_function = function (content)
				return content[hotspot_name].is_selected
			end
		}
		style[selected_texture_name] = {
			size = slot_size,
			color = select_color,
			offset = {
				offset[1],
		...
		content[selected_texture_name] = (center_button and "tabs_icon_bg_02_glow") or "tabs_icon_bg_01_glow"
		...
		content[background_name] = (center_button and "tabs_icon_bg_02") or "tabs_icon_bg_01"
		local counter_text = "counter" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "text",
			text_id = counter_text,
			style_id = counter_text,
		...
		passes[#passes + 1] = {
			...
			style_id = new_icon_name,
			content_check_function = function (content)
				return content[new_icon_name] and content["contains_new_content" .. name_suffix]
			end
		}
		style[new_icon_name] = {
			size = {
			...
			color = default_color,
			offset = {
				offset[1] + slot_size[1] - 126 + 25,
				offset[2] + slot_size[2] - 51 + 25,
				5
			}
		}
...
UIWidgets.create_menu_selector = function (scenegraph_id, amount, font_size)
	local widget = {
		element = {}
	}
	local passes = {}
	...
	for k = 1, amount, 1 do
		...
		content[hotspot_name] = {}
		local glow_texture_name = "glow" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "texture",
			texture_id = glow_texture_name,
			style_id = glow_texture_name,
			content_check_function = function (content)
				return content[hotspot_name].visible and content[hotspot_name].is_selected
			end
		}
		style[glow_texture_name] = {
			color = Colors.get_color_table_with_alpha("purple", 255),
			size = {
				100,
				50
			},
		...
		content[glow_texture_name] = "start_game_detail_glow"
		...
		passes[#passes + 1] = {
			...
			style_id = text_name,
			content_check_function = function (content)
				return content[hotspot_name].visible and not content[hotspot_name].is_hover and not content[hotspot_name].is_selected
			end
		}
		style[text_name] = {
			vertical_alignment = "center",
		...
		content[text_name] = "n/a"
		local text_hover_name = "text_hover" .. name_suffix
		passes[#passes + 1] = {
			pass_type = "text",
			text_id = text_name,
			style_id = text_hover_name,
			content_check_function = function (content)
				return content[hotspot_name].visible and (content[hotspot_name].is_hover or content[hotspot_name].is_selected)
			end
		}
		style[text_hover_name] = {
			vertical_alignment = "center",
			font_type = "hell_shark_header",
			horizontal_alignment = "left",
			font_size = font_size or 24,
