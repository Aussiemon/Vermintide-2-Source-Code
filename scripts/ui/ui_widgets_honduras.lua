...
UIWidgets.create_loadout_grid_console = function (scenegraph_id, size, rows, spacing, align_horizontal)
	local default_color = {
		255,
		255,
		255,
...
UIWidgets.create_layout_button = function (scenegraph_id, texture, hover_texture)
