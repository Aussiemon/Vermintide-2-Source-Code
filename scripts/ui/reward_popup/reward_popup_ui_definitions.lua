			...
			update = function (ui_scenegraph, scenegraph_definition, widget_type, progress, params)
				...
				for _, data in pairs(widget_type) do
					...
					elseif widget_type == "deus_icon" then
						local size_fraction = math.ease_out_exp(progress)
						local default_texture_size = widget.style.icon.default_texture_size
						widget.style.icon.texture_size[1] = default_texture_size[1] + default_texture_size[1] * (1 - size_fraction)
						widget.style.icon.texture_size[2] = default_texture_size[2] + default_texture_size[2] * (1 - size_fraction)
						local default_texture_size = widget.style.icon_bg.default_texture_size
						widget.style.icon_bg.texture_size[1] = default_texture_size[1] + default_texture_size[1] * (1 - size_fraction)
						widget.style.icon_bg.texture_size[2] = default_texture_size[2] + default_texture_size[2] * (1 - size_fraction)
						local default_texture_size = widget.style.rectangular_bg.default_texture_size
						widget.style.rectangular_bg.texture_size[1] = default_texture_size[1] + default_texture_size[1] * (1 - size_fraction)
						widget.style.rectangular_bg.texture_size[2] = default_texture_size[2] + default_texture_size[2] * (1 - size_fraction)
					end
				end
			end,
