...
OptionsView.cb_vsync_condition = function (self, content, style)
	...
	slot3 = if self:_get_current_render_setting("dlss_g_enabled")
	 then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
...
OptionsView.cb_lock_framerate_setup = function (self)
	...
	slot2 = if not FRAMERATE_CAP_LOOKUP[Application.user_setting("max_fps")
	...
	slot3 = if not FRAMERATE_CAP_LOOKUP[DefaultUserSettings.get("user_settings", "max_fps")
...
OptionsView.cb_lock_framerate_saved_value = function (self, widget)
	...
	slot4 = if not FRAMERATE_CAP_LOOKUP[max_fps] then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
...
OptionsView.cb_anti_aliasing_condition = function (self, content, style)
	...
	slot3 = if self:_get_current_render_setting("fsr_enabled")
	 then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	...
	if self:_get_current_render_setting("upscaling_mode")
	 == "dlss" then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
...
OptionsView.cb_fsr_enabled_condition = function (self, content, style)
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #3 4-9, warpins: 1 ---
	--- END OF BLOCK #3 ---

	slot3 = if self:_get_current_user_setting("dlss_enabled")
	 then
	JUMP TO BLOCK #4
	else
	JUMP TO BLOCK #5
	...
	slot3 = if self:_get_current_user_setting("fsr2_enabled")
	 then
	JUMP TO BLOCK #6
	else
	JUMP TO BLOCK #7
...
OptionsView.cb_fsr_quality_condition = function (self, content, style)
	...
	slot3 = if not self:_get_current_render_setting("fsr_enabled")
	 then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
...
OptionsView.cb_fsr2_enabled_condition = function (self, content, style)
	...
	slot3 = if not Application.render_caps("d3d12")
	 then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	...
	slot3 = if self:_get_current_render_setting("fsr2_enabled")
	 then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
...
OptionsView.cb_fsr2_quality_setup = function (self)
	...
	slot3 = if not FSR2_QUALITY_LOOKUP[upscaling_quality] then
	JUMP TO BLOCK #2
	else
	JUMP TO BLOCK #3
	end
...
OptionsView.cb_fsr2_quality_saved_value = function (self, widget)
	...
	slot4 = if not FSR2_QUALITY_LOOKUP[upscaling_quality] then
	JUMP TO BLOCK #4
	else
	JUMP TO BLOCK #5
	end
...
OptionsView.cb_fsr2_quality = function (self, content, style, called_from_graphics_quality)
	...
	slot5 = if self:_get_current_user_setting("fsr2_enabled")
...
OptionsView.cb_fsr2_quality_condition = function (self, content, style)
	...
	slot3 = if not self:_get_current_user_setting("fsr2_enabled")
...
OptionsView.cb_dlss_frame_generation_condition = function (self, content, style)
	...
	slot3 = if not Application.render_caps("dlss_g_supported")
	 then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	...
	slot3 = if not self:_get_current_user_setting("dlss_enabled")
	 then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
...
OptionsView.cb_dlss_super_resolution_setup = function (self)
	...
	slot4 = if self:_get_current_user_setting("dlss_enabled")
	...
	slot4 = if not DLSS_SR_QUALITY_LOOKUP[upscaling_quality] then
	JUMP TO BLOCK #4
	else
	JUMP TO BLOCK #5
	end
...
OptionsView.cb_reflex_low_latency = function (self, content, style, called_from_graphics_quality, called_from_override)
	...
	--- BLOCK #0 1-7, warpins: 1 ---
	local value = content.options_values[content.current_selection]
	local nv_low_latency_mode = false
	local nv_low_latency_boost = false
	--- END OF BLOCK #0 ---
	...
	slot4 = if not called_from_override then
	JUMP TO BLOCK #5
	else
	JUMP TO BLOCK #6
	end
...
OptionsView.cb_reflex_low_latency_condition = function (self, content, style)
	...
	if self.overriden_settings.reflex_low_latency == 1 then
	JUMP TO BLOCK #3
	else
	JUMP TO BLOCK #4
	end
...
OptionsView.cb_reflex_framerate_cap_setup = function (self)
	...
	slot2 = if not FRAMERATE_CAP_LOOKUP[Application.user_setting("render_settings", "nv_framerate_cap")
...
OptionsView.cb_reflex_framerate_cap_saved_value = function (self, widget)
	...
	slot4 = if not FRAMERATE_CAP_LOOKUP[nv_framerate_cap] then
	JUMP TO BLOCK #1
	else
	JUMP TO BLOCK #2
	end
...
OptionsView.cb_gamepad_look_sensitivity_setup = function (self)
	...
	slot16 = if base_filter.look_controller.multiplier_min_x then
	JUMP TO BLOCK #8
	else
	JUMP TO BLOCK #9
	end
	...
	slot16 = if not (base_filter.look_controller.multiplier_min_x * 0.85^(-sensitivity)) then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
	...
	slot18 = if base_filter.look_controller_melee.multiplier_min_x then
	JUMP TO BLOCK #11
	else
	JUMP TO BLOCK #12
	end
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #11 97-104, warpins: 1 ---
	--- END OF BLOCK #11 ---

	slot18 = if not (base_filter.look_controller_melee.multiplier_min_x * 0.85^(-sensitivity)) then
	JUMP TO BLOCK #12
	else
	JUMP TO BLOCK #13
	end
	...
	slot20 = if base_filter.look_controller_ranged.multiplier_min_x then
	JUMP TO BLOCK #14
	else
	JUMP TO BLOCK #15
	end
	...
	slot20 = if not (base_filter.look_controller_ranged.multiplier_min_x * 0.85^(-sensitivity)) then
	JUMP TO BLOCK #15
	else
	JUMP TO BLOCK #16
	end
	...
	slot20 = function_data.multiplier_x * 0.25
	--- END OF BLOCK #15 ---
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #16 129-136, warpins: 2 ---
	function_data.min_multiplier_x = slot20
...
OptionsView.cb_gamepad_zoom_sensitivity_setup = function (self)
	...
	slot14 = if base_filter.look_controller_zoom.multiplier_min_x then
	JUMP TO BLOCK #8
	else
	JUMP TO BLOCK #9
	end
	...
	slot14 = if not (base_filter.look_controller_zoom.multiplier_min_x * 0.85^(-sensitivity)) then
	JUMP TO BLOCK #9
	else
	JUMP TO BLOCK #10
	end
	...
	slot14 = function_data.multiplier_x * 0.25
	--- END OF BLOCK #9 ---
	...
	function_data.min_multiplier_x = slot14
...
OptionsView.cb_gamepad_look_invert_y_setup = function (self)
	...
	slot10 = "scale_vector3_xy_accelerated_x_inverted"
	--- END OF BLOCK #8 ---
	...
	slot12 = "scale_vector3_xy_accelerated_x_inverted"
	--- END OF BLOCK #11 ---
	...
	slot14 = "scale_vector3_xy_accelerated_x_inverted"
	--- END OF BLOCK #14 ---
	...
	slot16 = "scale_vector3_xy_accelerated_x_inverted"
	--- END OF BLOCK #17 ---
	...
	slot16 = "scale_vector3_xy_accelerated_x"
	--- END OF BLOCK #18 ---
	...
	function_data.filter_type = slot16
	--- END OF BLOCK #19 ---
...
OptionsView.cb_twitch_spawn_amount_setup = function (self)
	...
	slot4 = if not Application.user_setting("twitch_spawn_amount")
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #1 14-14, warpins: 1 ---
	local twitch_spawn_amount = default
	--- END OF BLOCK #1 ---
...
OptionsView.cb_twitch_spawn_amount_saved_value = function (self, widget)
	...
	slot5 = if not self:_get_current_user_setting("twitch_spawn_amount")
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #1 10-10, warpins: 1 ---
	local twitch_spawn_amount = content.default_value
	--- END OF BLOCK #1 ---
