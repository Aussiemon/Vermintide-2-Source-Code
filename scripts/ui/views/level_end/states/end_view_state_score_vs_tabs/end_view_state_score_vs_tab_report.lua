...
EndViewStateScoreVSTabReport.create_ui_elements = function (self, params)
...
EndViewStateScoreVSTabReport.draw = function (self, input_service, dt)
...
EndViewStateScoreVSTabReport._start_transition_animation = function (self, key, animation_name)
	local params = {
