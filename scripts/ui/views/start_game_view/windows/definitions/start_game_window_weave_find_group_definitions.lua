...
local function create_overlay_button(scenegraph_id, size)
	...
	local widget = {
		...
		content = {
			...
			option_text = Localize("start_game_window_weave_find_group"),
			warning_text = Localize("start_game_window_weave_group_is_full"),
			description_text = Localize("start_game_window_weave_find_group_description"),
			background = {
				uvs = {
					{
