...
local widgets = {
	...
	info_title = UIWidgets.create_simple_text(Localize("start_game_window_weave_find_group"), "info_title", nil, nil, info_title_style),
	info_divider = UIWidgets.create_simple_texture("divider_01_top", "info_divider"),
	info_description = UIWidgets.create_simple_text(Localize("start_game_window_weave_find_group_description"), "info_description", nil, nil, info_description_style),
	play_button_console = create_start_game_console_play_button("play_button_console", Localize("lb_search")),
	play_button = create_icon_and_name_button("play_button", "options_button_icon_quickplay", Localize("lb_search"))
}
