...
local function bogenhafen_background_widget(scenegraph_id, size)
	local widget = {
		element = {
			passes = {
				{
...
local widgets = {
	...
	dlc_background = bogenhafen_background_widget("dlc_background", scenegraph_definition.dlc_background.size),
