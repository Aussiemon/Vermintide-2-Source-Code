...
local scenegraph_definition = {
	...
	disconnect_texture = {
		vertical_alignment = "center",
		parent = "disconnect_button_frame",
		horizontal_alignment = "center",
		size = {
			64,
			64
...
local widgets = {
	background = UIWidgets.create_simple_texture("hud_difficulty_unlocked_bg_fade", "twitch_background"),
	...
	connect_texture = UIWidgets.create_simple_texture("", "connect_texture"),
	disconnect_texture = UIWidgets.create_simple_texture("", "disconnect_texture"),
...
widgets.connect_texture.element.passes[1].content_check_function = connected_content_check_function
...
widgets.disconnect_texture.element.passes[1].content_check_function = disconnected_content_check_function
