local definitions = local_require("scripts/ui/views/start_game_view/windows/definitions/start_game_window_twitch_login_console_definitions")
local widget_definitions = definitions.widgets
local scenegraph_definition = definitions.scenegraph_definition
local animation_definitions = definitions.animation_definitions
local DO_RELOAD = false
local CONNECT_INPUT = "special_1"
StartGameWindowTwitchLoginConsole = class(StartGameWindowTwitchLoginConsole)
StartGameWindowTwitchLoginConsole.NAME = "StartGameWindowTwitchLoginConsole"

StartGameWindowTwitchLoginConsole.on_enter = function (self, params, offset)
	print("[StartGameWindow] Enter Substate StartGameWindowTwitchLoginConsole")
...
StartGameWindowTwitchLoginConsole._setup_input_buttons = function (self)
	local input_service = self.parent:window_input_service()
	local connect_input_data = UISettings.get_gamepad_input_texture_data(input_service, CONNECT_INPUT, true)
	local widgets_by_name = self._widgets_by_name
	local connect_texture = widgets_by_name.connect_texture
	local connect_texture_style = connect_texture.style.texture_id
	connect_texture_style.horizontal_alignment = "center"
	connect_texture_style.vertical_alignment = "center"
	connect_texture_style.texture_size = {
		connect_input_data.size[1],
		connect_input_data.size[2]
	}
	connect_texture.content.texture_id = connect_input_data.texture
	local disconnect_texture = widgets_by_name.disconnect_texture
	local disconnect_texture_style = disconnect_texture.style.texture_id
	disconnect_texture_style.horizontal_alignment = "center"
	disconnect_texture_style.vertical_alignment = "center"
	disconnect_texture_style.texture_size = {
		connect_input_data.size[1],
		connect_input_data.size[2]
	}
	disconnect_texture.content.texture_id = connect_input_data.texture
end

StartGameWindowTwitchLoginConsole.create_ui_elements = function (self, params, offset)
...
StartGameWindowTwitchLoginConsole.on_exit = function (self, params)
	print("[StartGameWindow] Exit Substate StartGameWindowTwitchLoginConsole")
...
StartGameWindowTwitchLoginConsole.update = function (self, dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
StartGameWindowTwitchLoginConsole.set_active = function (self, active, skip_block)
	self._active = active
...
StartGameWindowTwitchLoginConsole._update_popup = function (self)
...
StartGameWindowTwitchLoginConsole._handle_input = function (self, dt, t)
	local input_service = self.parent:window_input_service()
...
StartGameWindowTwitchLoginConsole._update_game_options = function (self, dt, t)
	local is_connected = Managers.twitch:is_connected()
	local is_connecting = Managers.twitch:is_connecting()
...
StartGameWindowTwitchLoginConsole.cb_connection_error_callback = function (self, message)
	self._error_popup_id = Managers.popup:queue_popup(message, Localize("popup_header_error_twitch"), "ok", Localize("popup_choice_ok"))
end

StartGameWindowTwitchLoginConsole.cb_connection_success_callback = function (self, user_data)
	self:_set_disconnect_button_text()
end

StartGameWindowTwitchLoginConsole._set_disconnect_button_text = function (self)
...
StartGameWindowTwitchLoginConsole.cb_on_message_received = function (self, key, message_type, user_name, message, parameter)
	local chat_output_widget = self._widgets_by_name.chat_output_widget
	local chat_output_content = chat_output_widget.content
...
StartGameWindowTwitchLoginConsole._is_button_pressed = function (self, widget)
...
StartGameWindowTwitchLoginConsole._is_button_hover_enter = function (self, widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
StartGameWindowTwitchLoginConsole.post_update = function (self, dt, t)
	return
end

StartGameWindowTwitchLoginConsole._update_animations = function (self, dt)
...
StartGameWindowTwitchLoginConsole._update_button_animations = function (self, dt)
	local widgets_by_name = self._widgets_by_name
...
StartGameWindowTwitchLoginConsole._animate_button = function (self, widget, dt)
	local content = widget.content
...
StartGameWindowTwitchLoginConsole._update_private_option = function (self)
...
StartGameWindowTwitchLoginConsole._update_difficulty_option = function (self)
	local parent = self.parent
...
StartGameWindowTwitchLoginConsole._set_difficulty_option = function (self, difficulty_key)
	local widgets_by_name = self._widgets_by_name
...
StartGameWindowTwitchLoginConsole._exit = function (self, selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

StartGameWindowTwitchLoginConsole.draw = function (self, dt)
...
StartGameWindowTwitchLoginConsole._play_sound = function (self, event)
