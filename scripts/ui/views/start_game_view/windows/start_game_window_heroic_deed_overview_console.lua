...
StartGameWindowHeroicDeedOverviewConsole._get_selection_frame_by_difficulty_index = function (self, difficulty_index)
...
StartGameWindowHeroicDeedOverviewConsole._update_difficulty_option = function (self)
...
StartGameWindowHeroicDeedOverviewConsole._update_selector = function (self, selected_widget_name)
	local widgets_by_name = self._widgets_by_name
...
StartGameWindowHeroicDeedOverviewConsole._update_layout = function (self, selected_widget_name)
	local layout_name = layout_mapping[selected_widget_name]

	self._parent:set_layout_by_name(layout_name)
end

StartGameWindowHeroicDeedOverviewConsole._move_selector = function (self, selector_widget, selected_widget)
