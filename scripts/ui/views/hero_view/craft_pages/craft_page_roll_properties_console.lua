...
CraftPageRollPropertiesConsole.on_enter = function (self, params, settings)
...
CraftPageRollPropertiesConsole.setup_recipe_requirements = function (self)
...
CraftPageRollPropertiesConsole.reset_requirements = function (self, num_required_ingredients)
...
CraftPageRollPropertiesConsole.create_ui_elements = function (self, params)
...
CraftPageRollPropertiesConsole.on_exit = function (self, params)
...
CraftPageRollPropertiesConsole.update = function (self, dt, t)
	if DO_RELOAD then
		DO_RELOAD = false
...
CraftPageRollPropertiesConsole.post_update = function (self, dt, t)
	return
end

CraftPageRollPropertiesConsole._update_animations = function (self, dt)
...
CraftPageRollPropertiesConsole._is_button_pressed = function (self, widget)
...
CraftPageRollPropertiesConsole._is_button_hovered = function (self, widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
CraftPageRollPropertiesConsole._is_button_held = function (self, widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
CraftPageRollPropertiesConsole._handle_input = function (self, dt, t)
...
CraftPageRollPropertiesConsole._handle_craft_input_progress = function (self, progress)
	return self.parent:_set_input_progress(progress)
end

CraftPageRollPropertiesConsole.craft_result = function (self, result, error, reset_slots)
	if not error then
		self._craft_result = result
	end
end

CraftPageRollPropertiesConsole.reset = function (self)
...
CraftPageRollPropertiesConsole.present_results = function (self)
	local item_grid = self._item_grid
...
CraftPageRollPropertiesConsole.on_craft_completed = function (self)
...
CraftPageRollPropertiesConsole._update_craft_items = function (self)
	local super_parent = self.super_parent
	local item_grid = self._item_grid
...
CraftPageRollPropertiesConsole._remove_craft_item = function (self, backend_id, slot_index, ignore_sound)
	local craft_items = self._craft_items
...
CraftPageRollPropertiesConsole._add_craft_item = function (self, backend_id, slot_index, ignore_sound)
...
CraftPageRollPropertiesConsole._set_craft_button_disabled = function (self, disabled)
...
CraftPageRollPropertiesConsole.draw = function (self, dt)
...
CraftPageRollPropertiesConsole._play_sound = function (self, event)
	self.super_parent:play_sound(event)
end

CraftPageRollPropertiesConsole._set_craft_button_text = function (self, text, localize)
	local widgets_by_name = self._widgets_by_name
	local widget = widgets_by_name.craft_button
...
CraftPageRollPropertiesConsole._clear_item_grid = function (self)
	local craft_items = self._craft_items
	local super_parent = self.super_parent
...
CraftPageRollPropertiesConsole._has_added_item_by_id = function (self, backend_id)
	local craft_items = self._craft_items
