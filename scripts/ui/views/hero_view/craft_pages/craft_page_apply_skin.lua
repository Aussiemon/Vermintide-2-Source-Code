...
CraftPageApplySkin.on_enter = function (self, params, settings)
	...
	self._item_grid_2 = ItemGridUI:new(category_settings, self._widgets_by_name.item_grid_2)
...
CraftPageApplySkin._remove_craft_item = function (self, backend_id, slot_index)
	local craft_items = self._craft_items
...
CraftPageApplySkin._add_craft_item = function (self, backend_id, slot_index, ignore_sound)
	if self._num_craft_items == 0 then
