...
CraftPageCraftItemConsole.on_enter = function (self, params, settings)
...
CraftPageCraftItemConsole.reset_requirements = function (self, num_required_ingredients)
...
CraftPageCraftItemConsole.on_exit = function (self, params)
...
CraftPageCraftItemConsole.post_update = function (self, dt, t)
	return
end

CraftPageCraftItemConsole._update_animations = function (self, dt)
...
CraftPageCraftItemConsole._is_button_pressed = function (self, widget)
...
CraftPageCraftItemConsole._is_button_hovered = function (self, widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
CraftPageCraftItemConsole._is_button_held = function (self, widget)
	local content = widget.content
	local hotspot = content.button_hotspot
...
CraftPageCraftItemConsole._handle_input = function (self, dt, t)
...
CraftPageCraftItemConsole._handle_craft_input_progress = function (self, progress)
	return self.parent:_set_input_progress(progress)
end

CraftPageCraftItemConsole.craft_result = function (self, result, error, reset_slots)
	if not error then
...
CraftPageCraftItemConsole._remove_craft_item = function (self, backend_id, slot_index)
	local craft_items = self._craft_items
...
CraftPageCraftItemConsole._add_craft_item = function (self, backend_id, slot_index, ignore_sound)
...
CraftPageCraftItemConsole._has_added_item_by_id = function (self, backend_id)
	local craft_items = self._craft_items
...
CraftPageCraftItemConsole._set_craft_button_disabled = function (self, disabled)
...
CraftPageCraftItemConsole._exit = function (self, selected_level)
	self.exit = true
	self.exit_level_id = selected_level
end

CraftPageCraftItemConsole.draw = function (self, dt)
...
CraftPageCraftItemConsole._play_sound = function (self, event)
...
CraftPageCraftItemConsole._add_crafting_material_requirement = function (self, index, item_key, amount_text, has_required_amount)
