...
local widgets = {
	...
	panel_edge_top = UIWidgets.create_tiled_texture("panel_edge_top", "store_menu_frame", {
		1,
		6
	}),
	...
	bottom_panel = UIWidgets.create_tiled_texture("bottom_panel", "menu_frame_bg_03", {
		256,
		256
	}, nil, nil, {
		255,
	...
	panel_edge_bottom = UIWidgets.create_tiled_texture("panel_edge_bottom", "store_menu_frame", {
		1,
		6
	}),
	...
	entry_panel_bg = UIWidgets.create_tiled_texture("panel_entry_area", "menu_frame_bg_07", {
		512,
		256
	}, nil, nil, {
		255,
	...
	entry_panel_bg_masked = UIWidgets.create_tiled_texture("panel_entry_area", "menu_frame_bg_07_glow", {
		512,
		256
	}, {
		0,
	...
	entry_panel_detail_left = UIWidgets.create_simple_uv_texture("store_menu_bg_end", {
		{
			0,
			0
		},
	...
	entry_panel_detail_right = UIWidgets.create_simple_uv_texture("store_menu_bg_end", {
		{
			1,
			0
		},
