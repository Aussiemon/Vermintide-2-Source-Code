...
StoreWindowItemDetails._present_item = function (self, item)
	...
	local sub_title_text = Localize(item_type)
	...
	self:_set_career_icons(career_icons)
...
StoreWindowItemDetails._set_career_icons = function (self, icons)
	local widgets_by_name = self._widgets_by_name
	local icon_widget = widgets_by_name.career_icons
	local background_widget = widgets_by_name.career_icons_backgrounds
	icon_widget.content.texture_id = icons
	icon_widget.style.texture_id.texture_amount = #icons
	background_widget.style.texture_id.texture_amount = #icons
end
