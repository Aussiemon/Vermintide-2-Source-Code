...
local function create_change_inventory_profile_button(scenegraph_id)
	return {
		scenegraph_id = scenegraph_id,
		element = {
			passes = {
				...
				},
				{
					...
					content_change_function = function (content, style, _, dt)
						...
						color[1] = 255 * UIUtils.animate_value(color[1] / 255, 5 * dt, is_hover)
					end
				}
			}
		},
		content = {
			bottom_glow = "play_glow_mask",
			switch_hero = "start_menu_switch_hero",
			button_hotspot = {}
		},
		style = {
			button_hotspot = {
