...
AlphaOverlay = class(AlphaOverlay)
...
AlphaOverlay.init = function (self)
...
AlphaOverlay.create_ui_elements = function (self, widget_definition)
	local widget_definition = UIWidgets.create_simple_texture("alpha_text", "beta_tag")
...
AlphaOverlay.update = function (self, dt)
	if DO_RELOAD then
		self:create_ui_elements()
	end
...
AlphaOverlay.draw = function (self, dt)
...
AlphaOverlay.destroy = function (self)
