...
transitions.leave_group = function (self)
	self:_cancel_popup()
...
transitions.leave_group_hero_view = function (self)
	self:_cancel_popup()
...
transitions.quit_game = function (self)
	self:_cancel_popup()
...
transitions.quit_game_hero_view = function (self)
	self:_cancel_popup()
...
transitions.return_to_title_screen = function (self)
	self:_cancel_popup()
...
transitions.return_to_title_screen_hero_view = function (self)
	self:_cancel_popup()
...
transitions.return_to_demo_title_screen = function (self)
	self:_cancel_popup()
...
transitions.return_to_demo_title_screen_hero_view = function (self)
	self:_cancel_popup()
...
transitions.restart_demo = function (self)
	self:_cancel_popup()
...
transitions.restart_demo_hero_view = function (self)
	self:_cancel_popup()
...
transitions.demo_invert_controls = function (self)
...
transitions.end_game = function (self)
...
transitions.do_return_to_title_screen = function (self)
	self:_cancel_popup()
...
transitions.do_return_to_title_screen_hero_view = function (self)
	self:_cancel_popup()
...
transitions.do_return_to_demo_title_screen = function (self)
	self.return_to_demo_title_screen = true
end

transitions.do_restart_demo = function (self)
	self.restart_demo = true
end

transitions.do_return_to_pc_menu = function (self)
	local network_server = Managers.state.network.network_server
...
transitions.leave_game = function (self)
	self:_cancel_popup()
...
transitions.leave_game_hero_view = function (self)
	self:_cancel_popup()
...
transitions.return_to_pc_menu = function (self)
	self:_cancel_popup()
...
transitions.return_to_pc_menu_hero_view = function (self)
	self:_cancel_popup()
...
transitions.ingame_menu = function (self)
	self.menu_active = true
	self.current_view = "ingame_menu"
end

transitions.chat_view = function (self)
	self.current_view = "chat_view"
end

transitions.chat_view_force = function (self)
...
transitions.hero_view_force = function (self)
	self.current_view = "hero_view"
	self.views[self.current_view].exit_to_game = true
end

transitions.hero_view = function (self)
	self.current_view = "hero_view"
end

transitions.spoils_of_war = function (self)
	self.current_view = "hero_view"
end

transitions.start_game_view_force = function (self)
	self.current_view = "start_game_view"
	self.views[self.current_view].exit_to_game = true
end

transitions.start_game_view = function (self)
	self.current_view = "start_game_view"
end

transitions.start_menu_view_force = function (self)
	self.current_view = "start_menu_view"
	self.views[self.current_view].exit_to_game = true
end

transitions.start_menu_view = function (self)
	self.current_view = "start_menu_view"
end

transitions.initial_start_menu_view_force = function (self)
	self.current_view = "start_menu_view"
	self.initial_profile_view = true
	self.views[self.current_view].exit_to_game = true
end

transitions.exit_initial_start_menu_view = function (self)
...
transitions.character_selection_force = function (self)
	self.current_view = "character_selection"
	self.views[self.current_view].exit_to_game = true
end

transitions.character_selection = function (self)
	self.current_view = "character_selection"
end

transitions.initial_character_selection_force = function (self, params)
	self.current_view = "character_selection"
	self.initial_profile_view = true
	self.views[self.current_view].exit_to_game = true
...
transitions.exit_initial_character_selection = function (self)
	self.menu_active = false
	self.current_view = nil
	self.initial_profile_view = nil
end

transitions.join_lobby = function (self, lobby_client)
	self.input_manager:block_device_except_service(nil, "keyboard", 1)
	self.input_manager:block_device_except_service(nil, "mouse", 1)
	self.input_manager:block_device_except_service(nil, "gamepad", 1)
...
transitions.exit_menu = function (self)
...
transitions.cancel_popup = function (self)
	self.popup_id = nil
...
transitions.cancel_popup_hero_view = function (self)
	self.popup_id = nil
...
transitions.credits_menu = function (self)
	self.current_view = "credits_view"
end

transitions.options_menu = function (self)
	self.current_view = "options_view"
end

transitions.console_friends_menu = function (self)
	self.current_view = "console_friends_view"
end

transitions.restart_game = function (self)
	self.input_manager:device_unblock_all_services("keyboard", 1)
	self.input_manager:device_unblock_all_services("mouse", 1)
	self.input_manager:device_unblock_all_services("gamepad", 1)
...
transitions.close_active = function (self)
...
view_settings.views_function = function (ingame_ui_context)
	local views = {
