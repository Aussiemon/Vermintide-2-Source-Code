...
local function create_player_texts(scenegraph_id)
	...
	local state_text_shadow = table.clone(state_text)
	state_text_shadow.text_color = Colors.get_color_table_with_alpha("black", 255)
	state_text_shadow.offset = {
		state_text.offset[1] + 2,
		state_text.offset[2] - 2,
		state_text.offset[3] - 1
	}
	local coins_icon = {
		offset = {
			0,
	...
	return {
		...
		style = {
			...
			state_text_shadow = state_text_shadow,
...
local function create_power_up_shop_item(scenegraph_id, size, masked, is_rectangular_icon)
	...
	if is_rectangular_icon then
		...
		style.icon_disabled.texture_size = {
			66,
			66
		}
		style.icon_disabled.offset = {
			7,
			0,
			5
		}
		content.icon_background = "button_frame_01"
		style.icon_background.texture_size = {
			80,
			80
		}
		style.icon_background.offset = {
			0,
			0,
			3
		}
		content.icon_discount_frame = "menu_frame_12_gold"
		style.icon_discount_frame.texture_size = {
			80,
			80
		}
		style.icon_discount_frame.offset = {
			0,
			0,
			6
		}
		content.icon_bought_frame = "frame_outer_glow_04_big"
		style.icon_bought_frame.texture_size = {
			158,
			158
		}
		style.icon_bought_frame.offset = {
			-39,
			0,
			2
		}
		content.icon_hover_frame = "frame_outer_glow_04"
		style.icon_hover_frame.texture_size = {
			128,
			128
		}
		style.icon_hover_frame.offset = {
			-24,
			0,
			3
		}
...
local widgets = {
	...
	bottom_text = UIWidgets.create_simple_text(nil, "bottom_text", nil, nil, bottom_text_style),
	...
	player_background = create_frame("player_background", 128),
...
for i = 1, player_amount, 1 do
	...
	scenegraph_definition[portrait_scenegraph_id] = {
		vertical_alignment = "bottom",
		parent = "player_background",
		horizontal_alignment = "left",
		size = player_widget_size,
		position = position
	}
	...
	scenegraph_definition[text_scenegraph_id] = {
		...
		size = player_widget_size,
		position = {
			position[1] + player_texts_offset[1],
			position[2] + player_texts_offset[2],
			1
		}
	}
