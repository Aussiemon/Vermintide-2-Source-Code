...
local widget_definitions = {
	window_background = UIWidgets.create_simple_texture("lake_upsell_popup_bg", "window", nil, nil, {
		255,
		155,
		155,
		155
	...
	title_text = UIWidgets.create_simple_text("upsell_popup_lake_title", "title", nil, nil, title_text_style),
	body_text = UIWidgets.create_simple_text("upsell_popup_lake_body", "body", nil, nil, body_text_style),
	...
	store_button = create_frameless_button("store_button", scenegraph_definition.store_button.size, nil, Localize("upsell_popup_lake_button"), nil, "hell_shark_header", false, "white", "button_detail_01_gold", nil, disable_with_gamepad)
}
