...
BTSelector_horde_rat_defend_destructible.init = function (self, ...)
	BTSelector_horde_rat_defend_destructible.super.init(self, ...)

	self._children = {}
end

BTSelector_horde_rat_defend_destructible.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_horde_rat_defend_destructible.run = function (self, unit, blackboard, t, dt)
...
BTSelector_horde_rat_defend_destructible.add_child = function (self, node)
