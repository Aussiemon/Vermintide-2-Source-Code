...
BTSelector_pet_skeleton_dual_wield.init = function (self, ...)
	BTSelector_pet_skeleton_dual_wield.super.init(self, ...)

	self._children = {}
end

BTSelector_pet_skeleton_dual_wield.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_pet_skeleton_dual_wield.run = function (self, unit, blackboard, t, dt)
...
BTSelector_pet_skeleton_dual_wield.add_child = function (self, node)
