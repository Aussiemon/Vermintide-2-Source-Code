...
BTSelector_gor.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_gor.run = function (self, unit, blackboard, t, dt)
...
BTSelector_gor.add_child = function (self, node)
