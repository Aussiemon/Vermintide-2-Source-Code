...
BTSelector_ethereal_skeleton_with_shield.init = function (self, ...)
	BTSelector_ethereal_skeleton_with_shield.super.init(self, ...)

	self._children = {}
end

BTSelector_ethereal_skeleton_with_shield.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_ethereal_skeleton_with_shield.run = function (self, unit, blackboard, t, dt)
...
BTSelector_ethereal_skeleton_with_shield.add_child = function (self, node)
