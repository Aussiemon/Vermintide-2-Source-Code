...
BTSelector_curse_mutator_sorcerer.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_curse_mutator_sorcerer.run = function (self, unit, blackboard, t, dt)
...
BTSelector_curse_mutator_sorcerer.add_child = function (self, node)
