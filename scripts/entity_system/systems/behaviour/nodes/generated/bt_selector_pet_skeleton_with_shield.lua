...
BTSelector_pet_skeleton_with_shield.init = function (self, ...)
	BTSelector_pet_skeleton_with_shield.super.init(self, ...)

	self._children = {}
end

BTSelector_pet_skeleton_with_shield.leave = function (self, unit, blackboard, t, reason)
...
BTSelector_pet_skeleton_with_shield.add_child = function (self, node)
