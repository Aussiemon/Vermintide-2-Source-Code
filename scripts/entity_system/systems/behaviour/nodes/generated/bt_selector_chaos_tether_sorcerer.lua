...
BTSelector_chaos_tether_sorcerer.init = function (self, ...)
	BTSelector_chaos_tether_sorcerer.super.init(self, ...)

	self._children = {}
end

BTSelector_chaos_tether_sorcerer.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_chaos_tether_sorcerer.run = function (self, unit, blackboard, t, dt)
...
BTSelector_chaos_tether_sorcerer.add_child = function (self, node)
