...
BTSelector_slave_rat.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_slave_rat.run = function (self, unit, blackboard, t, dt)
...
BTSelector_slave_rat.add_child = function (self, node)
