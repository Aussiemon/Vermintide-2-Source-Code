...
BTSelector_standard_bearer.run = function (self, unit, blackboard, t, dt)
	...
	do
		...
		elseif condition_result == nil then
			condition_result = blackboard.has_placed_standard and unit_alive(blackboard.target_unit) and HEALTH_ALIVE[blackboard.standard_unit] and target_distance_to_standard and target_distance_to_standard > blackboard.breed.pickup_standard_distance
		end
