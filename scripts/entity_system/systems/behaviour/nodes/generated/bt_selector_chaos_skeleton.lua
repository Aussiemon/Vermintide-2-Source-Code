...
BTSelector_chaos_skeleton.init = function (self, ...)
	BTSelector_chaos_skeleton.super.init(self, ...)

	self._children = {}
end

BTSelector_chaos_skeleton.leave = function (self, unit, blackboard, t, reason)
...
BTSelector_chaos_skeleton.add_child = function (self, node)
