...
BTSelector_ethereal_skeleton_with_hammer.init = function (self, ...)
	BTSelector_ethereal_skeleton_with_hammer.super.init(self, ...)

	self._children = {}
end

BTSelector_ethereal_skeleton_with_hammer.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_ethereal_skeleton_with_hammer.run = function (self, unit, blackboard, t, dt)
...
BTSelector_ethereal_skeleton_with_hammer.add_child = function (self, node)
