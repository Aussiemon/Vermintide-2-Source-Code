-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_human_pleb.lua
...
BTSelector_human_pleb = class(BTSelector_human_pleb, BTNode)
BTSelector_human_pleb.name = "BTSelector_human_pleb"

BTSelector_human_pleb.init = function (self, ...)
	BTSelector_human_pleb.super.init(self, ...)

	self._children = {}
end

BTSelector_human_pleb.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_human_pleb.run = function (self, unit, blackboard, t, dt)
...
BTSelector_human_pleb.add_child = function (self, node)
