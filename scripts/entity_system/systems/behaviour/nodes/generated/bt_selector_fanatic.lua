...
BTSelector_fanatic.init = function (self, ...)
	BTSelector_fanatic.super.init(self, ...)

	self._children = {}
end

BTSelector_fanatic.leave = function (self, unit, blackboard, t, reason)
	self:set_running_child(unit, blackboard, t, nil, reason)
end

BTSelector_fanatic.run = function (self, unit, blackboard, t, dt)
...
BTSelector_fanatic.add_child = function (self, node)
