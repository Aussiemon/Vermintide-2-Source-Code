local ObjectiveSystemTestify = {
	versus_objective_add_time = function (time, objective_system)
		objective_system:add_time(time)
	end,
	versus_current_objective_position = function (_, objective_system)
	...
	versus_complete_objectives = function (_, objective_system)
		local _, extension = next(objective_system._main_objectives)
	...
	versus_objective_name = function (_, objective_system)
		local _, extension = next(objective_system._main_objectives)

		return extension:objective_name()
	end,
	versus_objective_type = function (_, objective_system)
		local _, extension = next(objective_system._main_objectives)
	...
	weave_spawn_essence_on_first_bot_position = function (_, objective_system)
