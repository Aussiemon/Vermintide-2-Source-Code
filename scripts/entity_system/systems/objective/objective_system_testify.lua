...
ObjectiveSystemTestify.versus_objective_add_time = function (objective_system, time)
	objective_system:add_time(time)
end

ObjectiveSystemTestify.versus_current_objective_position = function (objective_system)
...
ObjectiveSystemTestify.versus_complete_objectives = function (objective_system)
	local _, extension = next(objective_system._main_objectives)
...
ObjectiveSystemTestify.versus_objective_name = function (objective_system)
	local _, extension = next(objective_system._main_objectives)

	return extension:objective_name()
end

ObjectiveSystemTestify.versus_objective_type = function (objective_system)
	local _, extension = next(objective_system._main_objectives)
...
ObjectiveSystemTestify.weave_spawn_essence_on_first_bot_position = function (objective_system)
