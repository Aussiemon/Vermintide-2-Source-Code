...
StoreLayoutConfig.pages.featured = {
	...
	slideshow = {
		...
		{
			description = "test_2",
			product_id = "skin_es_knight_green",
			texture = "icons_placeholder",
			header = "test_2"
		},
		{
			description = "test_3",
			product_id = "pre_order",
			texture = "level_icon_05",
			header = "test_3"
		}
	},
	grid = {
...
StoreLayoutConfig.pages.currency = {
...
StoreLayoutConfig.pages.extras = {
	sound_event_enter = "Play_hud_store_category_other",
	layout = "category",
	display_name = "menu_store_panel_title_extras"
}
StoreLayoutConfig.pages.pets = {
	item_filter = "item_type == hat or item_type == skin",
	layout = "item_list",
	display_name = "pets",
	type = "item"
}
StoreLayoutConfig.pages.frames = {
	...
	layout = "item_list",
	display_name = "inventory_screen_frames_title",
	type = "item"
}
...
StoreLayoutConfig.pages.bogenhafen = {
	display_name = "title_screen_store_bogenhafen_title",
	layout = "item_list",
	item_filter = "item_type == hat",
	type = "item"
}
StoreLayoutConfig.pages.collectors = {
	display_name = "gift_popup_text_vt2_collectors_edition",
	layout = "item_list",
	item_filter = "item_type == hat",
	type = "item"
}
