...
local weapon_template = {
	...
	default_spread_template = "rake_shot",
	right_hand_unit = "",
	right_hand_attachment_node_linking = AttachmentNodeLinking.grudge_raker,
	display_unit = "units/weapons/weapon_display/display_1h_grudge_raker",
	wield_anim = "to_grudge_raker",
	wield_anim_no_ammo = "to_grudge_raker_noammo",
