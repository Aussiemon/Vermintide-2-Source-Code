...
local weapon_template = {
	...
	wield_anim = "to_fencing_sword",
	reload_event = "reload",
	buff_type = "MELEE_1H",
	weapon_type = "FENCING_SWORD_1H",
	max_fatigue_points = 6,
	dodge_count = 6,
	block_angle = 90,
	outer_block_angle = 360,
	block_fatigue_point_multiplier = 0.25,
	...
	tooltip_special_action_description = "special_action_fencing_sword"
}
