...
return {
	one_handed_hammer_book_priest_template = table.clone(weapon_template),
	one_handed_hammer_book_priest_preview_template = table.clone(one_handed_hammer_book_priest_preview)
}
