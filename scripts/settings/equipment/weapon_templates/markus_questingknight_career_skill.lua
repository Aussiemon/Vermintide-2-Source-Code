...
weapon_template.actions = {
	action_career_hold = {
			...
			conditional_actions = {
				{
					...
					condition = function (talent_extension, buff_extension)
						return talent_extension:has_talent("markus_questing_knight_ability_tank_attack")
					end
				},
				{
					sub_action = "default_3",
					condition = function (talent_extension, buff_extension)
						return talent_extension:has_talent("markus_questing_knight_ability_double_activation")
					end
				}
			},
			default_action = {
		...
		default_4 = {
			...
			kind = "career_dummy",
			uninterruptible = true,
			anim_event = "questing_knight_ability_double_activation_combo_charge",
			anim_end_event_condition_func = function (unit, end_reason)
				return end_reason ~= "new_interupting_action"
			end,
			total_time = math.huge,
