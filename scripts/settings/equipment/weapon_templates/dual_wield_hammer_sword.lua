...
local weapon_template = {
	...
	right_hand_unit = "units/weapons/player/wpn_emp_mace_04_t1/wpn_emp_mace_04_t1",
	...
	wield_anim = "to_dual_hammer_sword_es",
	attack_meta_data = {
		tap_attack = {
			penetrating = false,
			arc = 0
...
return {
	dual_wield_hammer_sword_template = weapon_template
}
