...
weapon_template.state_machine = "units/beings/player/first_person_base/state_machines/melee/2h_hammer_priest"
...
weapon_template.tooltip_special_action_description = "special_action_2h_hammer_priest"
