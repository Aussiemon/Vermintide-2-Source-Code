...
Weapons = Weapons or {}
Weapons.we_one_hand_axe_template = table.clone(weapon_template)
Weapons.we_one_hand_axe_template_un = table.clone(Weapons.we_one_hand_axe_template)
Weapons.we_one_hand_axe_template_un.actions.action_inspect.action_inspect_hold.anim_event = "inspect_start_2"
Weapons.we_one_hand_axe_template_un.actions.action_inspect.action_inspect_hold.anim_end_event = "inspect_end_2"
