...
Weapons = Weapons or {}
Weapons.dual_wield_hammers_template = table.clone(weapon_template)
Weapons.dual_wield_hammers_template_un = table.clone(Weapons.dual_wield_hammers_template)
Weapons.dual_wield_hammers_template_un.actions.action_inspect.default.anim_event = "inspect_start"
Weapons.dual_wield_hammers_template_un.actions.action_inspect.default.anim_end_event = "inspect_end"
