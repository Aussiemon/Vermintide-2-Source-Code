...
weapon_template.actions = {
	action_one = {
		...
		heavy_attack = {
			...
			anim_end_event = "attack_finished",
			damage_profile_right = "medium_blunt_tank_1h",
...
Weapons = Weapons or {}
Weapons.dual_wield_hammer_sword_template = table.clone(weapon_template)
Weapons.dual_wield_hammer_sword_template_un = table.clone(Weapons.dual_wield_hammer_sword_template)
Weapons.dual_wield_hammer_sword_template_un.actions.action_inspect.default.anim_event = "inspect_start"
Weapons.dual_wield_hammer_sword_template_un.actions.action_inspect.default.anim_end_event = "inspect_end"
