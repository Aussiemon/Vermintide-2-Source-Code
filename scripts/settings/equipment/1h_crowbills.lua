...
Weapons = Weapons or {}
Weapons.one_handed_crowbill = table.clone(weapon_template)
Weapons.one_handed_crowbill_un = table.clone(Weapons.one_handed_crowbill)
Weapons.one_handed_crowbill_un.actions.action_inspect.action_inspect_hold.anim_event = "inspect_start"
Weapons.one_handed_crowbill_un.actions.action_inspect.action_inspect_hold.anim_end_event = "inspect_end"
