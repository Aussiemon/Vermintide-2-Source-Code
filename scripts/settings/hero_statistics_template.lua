HeroStatisticsTemplate = {
	...
	},
	{
		...
		generate_description = function (params)
			...
			local modified_health = buff_extension:apply_buffs_to_value(base_max_health, StatBuffIndex.MAX_HEALTH)
	...
	},
	{
		...
		generate_description = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_critical_strike_boost = 1
			local modifier = buff_extension:apply_buffs_to_value(base_critical_strike_boost, StatBuffIndex.CRITICAL_STRIKE_EFFECTIVENESS)
	...
	},
	{
		...
		generate_description = function (params)
			...
			local buff_extension = ScriptUnit.has_extension(player_unit, "buff_system")
			local base_headshot_damage = 1
			local modifier = buff_extension:apply_buffs_to_value(base_headshot_damage, StatBuffIndex.HEADSHOT_MULTIPLIER)
