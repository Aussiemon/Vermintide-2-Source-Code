-- chunkname: @scripts/settings/hit_effects/hit_effects_human_pleb.lua
...
local function get_variable(template, ...)
	...
	return val or template.inherits and get_variable(HitEffectsHumanPleb[template.inherits], ...)
end

for hit_effect_name, hit_effect_data in pairs(HitEffectsHumanPleb) do
	...
	if death and critical_variant then
		...
		HitEffectsHumanPleb[new_hit_effect_name] = new_hit_effect_data
	end
end

HitEffectsHumanPleb = table.create_copy(HitEffectsHumanPleb, HitEffectsHumanPleb)
