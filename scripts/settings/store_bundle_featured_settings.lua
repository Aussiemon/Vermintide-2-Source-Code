StoreBundleFeaturedSettings = {
	{
		store_banner_texture_paths = "gui/1080p/single_textures/store/slideshow/store_slideshow_bundle_bountyhunter",
		prio = 200,
		hide_from_slideshow = false,
		header = "bounty_hunter_bundle_01",
		slideshow_texture = "store_slideshow_bundle_bountyhunter",
	...
	{
		store_banner_texture_paths = "gui/1080p/single_textures/store/slideshow/store_slideshow_bundle_shade",
		prio = 100,
		hide_from_slideshow = false,
		header = "shade_bundle_01",
		slideshow_texture = "store_slideshow_bundle_shade",
