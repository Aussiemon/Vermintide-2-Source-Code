...
local skin_es_questingknight_black_and_gold = {
	first_person_bot = "units/beings/player/first_person_base/chr_first_person_bot_base",
	first_person = "units/beings/player/first_person_base/chr_first_person_base",
	third_person = "units/beings/player/empire_soldier_breton/third_person_base/chr_third_person_base",
	third_person_bot = "units/beings/player/empire_soldier_breton/third_person_base/chr_third_person_base",
...
return {
	skin_es_questingknight = table.clone(skin_es_questingknight),
	skin_es_questingknight_black_and_gold = table.clone(skin_es_questingknight_black_and_gold),
	skin_es_questingknight_black_and_yellow = table.clone(skin_es_questingknight_black_and_yellow),
	skin_es_questingknight_blue_and_white = table.clone(skin_es_questingknight_blue_and_white),
	skin_es_questingknight_yellow_and_white = table.clone(skin_es_questingknight_yellow_and_white)
}
