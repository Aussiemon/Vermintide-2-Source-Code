...
return {
	skin_dr_engineer = table.clone(skin_dr_engineer),
	skin_dr_engineer_black_and_gold = table.clone(skin_dr_engineer_black_and_gold),
	skin_dr_engineer_blue_and_gold = table.clone(skin_dr_engineer_blue_and_gold),
	skin_dr_engineer_brown_and_iron = table.clone(skin_dr_engineer_brown_and_iron),
	skin_dr_engineer_purple_and_copper = table.clone(skin_dr_engineer_purple_and_copper)
}
