...
settings.ui_materials = {
	...
	"materials/ui/ui_1080p_morris_portrait_frames_atlas",
	"materials/ui/ui_1080p_morris_icon_portrait_frames_atlas",
	"materials/ui/ui_1080p_morris_achievements_atlas"
}
...
settings.ui_texture_settings = {
	filenames = {
		"scripts/ui/atlas_settings/gui_morris_icons_atlas",
		"scripts/ui/atlas_settings/gui_morris_start_game_atlas",
		"scripts/ui/atlas_settings/gui_morris_portrait_frames_atlas",
		"scripts/ui/atlas_settings/gui_morris_icon_portrait_frames_atlas",
		"scripts/ui/atlas_settings/gui_morris_achievements_atlas"
	},
	atlas_settings = {
		morris_icons_atlas = {
			offscreen_material_name = "gui_morris_icons_atlas_offscreen",
			masked_point_sample_material_name = "gui_morris_icons_atlas_point_sample_masked",
			masked_offscreen_material_name = "gui_morris_icons_atlas_masked_offscreen",
			point_sample_offscreen_material_name = "gui_morris_icons_atlas_point_sample_offscreen",
			saturated_material_name = "gui_morris_icons_atlas_saturated",
			masked_material_name = "gui_morris_icons_atlas_masked",
			point_sample_material_name = "gui_morris_icons_atlas_point_sample",
			masked_saturated_material_name = "gui_morris_icons_atlas_masked_saturated",
			saturated_offscreen_material_name = "gui_morris_icons_atlas_saturated",
			masked_point_sample_offscreen_material_name = "gui_morris_icons_atlas_point_sample_masked_offscreen",
			material_name = "gui_morris_icons_atlas"
		},
		morris_start_game_atlas = {
			offscreen_material_name = "gui_morris_start_game_atlas_offscreen",
			masked_point_sample_material_name = "gui_morris_start_game_atlas_point_sample_masked",
			masked_offscreen_material_name = "gui_morris_start_game_atlas_masked_offscreen",
			point_sample_offscreen_material_name = "gui_morris_start_game_atlas_point_sample_offscreen",
			saturated_material_name = "gui_morris_start_game_atlas_saturated",
			masked_material_name = "gui_morris_start_game_atlas_masked",
			point_sample_material_name = "gui_morris_start_game_atlas_point_sample",
			masked_saturated_material_name = "gui_morris_start_game_atlas_masked_saturated",
			saturated_offscreen_material_name = "gui_morris_start_game_atlas_saturated",
			masked_point_sample_offscreen_material_name = "gui_morris_start_game_atlas_point_sample_masked_offscreen",
			material_name = "gui_morris_start_game_atlas"
		},
		morris_portrait_frames_atlas = {
			offscreen_material_name = "gui_morris_portrait_frames_atlas_offscreen",
			masked_point_sample_material_name = "gui_morris_portrait_frames_atlas_point_sample_masked",
			masked_offscreen_material_name = "gui_morris_portrait_frames_atlas_masked_offscreen",
			point_sample_offscreen_material_name = "gui_morris_portrait_frames_atlas_point_sample_offscreen",
			saturated_material_name = "gui_morris_portrait_frames_atlas_saturated",
			masked_material_name = "gui_morris_portrait_frames_atlas_masked",
			point_sample_material_name = "gui_morris_portrait_frames_atlas_point_sample",
			masked_saturated_material_name = "gui_morris_portrait_frames_atlas_masked_saturated",
			saturated_offscreen_material_name = "gui_morris_portrait_frames_atlas_saturated",
			masked_point_sample_offscreen_material_name = "gui_morris_portrait_frames_atlas_point_sample_masked_offscreen",
			material_name = "gui_morris_portrait_frames_atlas"
		},
		morris_icon_portrait_frames_atlas = {
			offscreen_material_name = "gui_morris_icon_portrait_frames_atlas_offscreen",
			masked_point_sample_material_name = "gui_morris_icon_portrait_frames_atlas_point_sample_masked",
			masked_offscreen_material_name = "gui_morris_icon_portrait_frames_atlas_masked_offscreen",
			point_sample_offscreen_material_name = "gui_morris_icon_portrait_frames_atlas_point_sample_offscreen",
			saturated_material_name = "gui_morris_icon_portrait_frames_atlas_saturated",
			masked_material_name = "gui_morris_icon_portrait_frames_atlas_masked",
			point_sample_material_name = "gui_morris_icon_portrait_frames_atlas_point_sample",
			masked_saturated_material_name = "gui_morris_icon_portrait_frames_atlas_masked_saturated",
			saturated_offscreen_material_name = "gui_morris_icon_portrait_frames_atlas_saturated",
			masked_point_sample_offscreen_material_name = "gui_morris_icon_portrait_frames_atlas_point_sample_masked_offscreen",
			material_name = "gui_morris_icon_portrait_frames_atlas"
		},
		morris_achievements_atlas = {
			offscreen_material_name = "gui_morris_achievements_atlas_offscreen",
			masked_point_sample_material_name = "gui_morris_achievements_atlas_point_sample_masked",
			masked_offscreen_material_name = "gui_morris_achievements_atlas_masked_offscreen",
			point_sample_offscreen_material_name = "gui_morris_achievements_atlas_point_sample_offscreen",
			saturated_material_name = "gui_morris_achievements_atlas_saturated",
			masked_material_name = "gui_morris_achievements_atlas_masked",
			point_sample_material_name = "gui_morris_achievements_atlas_point_sample",
			masked_saturated_material_name = "gui_morris_achievements_atlas_masked_saturated",
			saturated_offscreen_material_name = "gui_morris_achievements_atlas_saturated",
			masked_point_sample_offscreen_material_name = "gui_morris_achievements_atlas_point_sample_masked_offscreen",
			material_name = "gui_morris_achievements_atlas"
		}
	}
}
