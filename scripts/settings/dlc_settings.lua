...
DLCSettings = {
	full_game = {
		...
		breeds = {
			...
			"scripts/settings/breeds/breed_chaos_exalted_champion",
		...
		behaviour_trees_precompiled = {
			"scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_exalted_champion_warcamp",
		...
		behaviour_trees = {
			"scripts/entity_system/systems/behaviour/trees/chaos/chaos_exalted_champion_behavior",
