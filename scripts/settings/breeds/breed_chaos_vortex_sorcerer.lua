...
local action_data = {
	...
	spawn_vortex = {
		outer_decal_unit_name = "units/decals/decal_nurgle_pentagram_1",
		vortex_template_name = "standard",
		missile_speed = 30,
		missile_life_time = 3.25,
		missile_effect_unit_name = "units/weapons/projectile/vortex_rune/vortex_rune",
		summoning_time = 3.5,
		missile_cast_interval = 0.1,
		attack_anim = "attack_cast_spell_loop",
		num_missiles = 15,
		spawn_func_name = "_spawn_vortex",
		extra_time_per_distance = 0.03333333333333333,
		...
		missile_launch_angle = math.pi/8,
		ignore_staggers = {
			true,
			true,
			true,
