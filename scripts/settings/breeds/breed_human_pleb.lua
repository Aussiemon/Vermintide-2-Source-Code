-- chunkname: @scripts/settings/breeds/breed_human_pleb.lua
...
local breed_data = {
	...
	base_unit = "units/beings/npcs/pleb/chr_npc_pleb_male",
	behavior = "human_pleb",
	bone_lod_level = 0,
	death_reaction = "ai_default",
	death_sound_event = "Play_npc_human_soldier_vce_death",
	default_inventory_template = "human_pleb",
	default_mover = "standing",
	detection_radius = 12,
	dialogue_source_name = "npc_human_pleb",
...
Breeds.human_pleb = table.create_copy(Breeds.human_pleb, breed_data)
...
BreedActions.human_pleb = table.create_copy(BreedActions.human_pleb, action_data)
