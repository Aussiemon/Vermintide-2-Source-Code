...
local num_flower_waves = 20
local angle_between_flower_waves = (math.pi*2)/((num_flower_waves + 1)*0.5)
local action_data = {
	skulking = {
...
action_data.plague_wave_skulking = copy_action_data("plague_wave_skulking", action_data.skulking, "plague_wave")
