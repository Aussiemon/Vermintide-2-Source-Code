...
local action_data = {
	...
	grab_attack = {
		grabbed_sound_event_2d = "chaos_corruptor_corrupting",
		dodge_angle = 12.5,
		cooldown = 4,
		drain_life_tick_rate = 1,
		disable_player_time = 10,
		projectile_radius = 2,
		fatigue_type = "blocked_attack",
		dodge_distance = 4,
		grabbed_sound_event_2d_stop = "chaos_corruptor_corrupting_stop",
		damage_type = "cutting",
		unblockable = true,
